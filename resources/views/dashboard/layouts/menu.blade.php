    ...
    <div class="mdk-drawer__content">
        <div class="sidebar sidebar-dark sidebar-left sidebar-p-t bg-dark" data-perfect-scrollbar>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" data-toggle="collapse" href="#hotels">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i>
                        <span class="sidebar-menu-text"> {{ __('admin.hotels') }} </span>
                        <span class="ml-auto sidebar-menu-toggle-icon"></span>
                    </a>
                    <ul class="sidebar-submenu collapse" id="hotels">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{ route('hotels.index') }}">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{ route('offers.index') }}">
                                <i class="fa fa-rss"></i>
                                <span class="sidebar-menu-text"> {{ __('admin.hotels_offers') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="{{ route('trips.index') }}">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">slideshow</i>
                        <span class="sidebar-menu-text"> {{ __('admin.trips') }} </span>
                    </a>
                </li>

                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="{{ route('booking-orders.index') }}">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">slideshow</i>
                        <span class="sidebar-menu-text"> {{ __('admin.booking_orders') }} </span>
                    </a>
                </li>
