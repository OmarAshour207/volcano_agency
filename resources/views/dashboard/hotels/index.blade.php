                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('admin.hotels') }}</li>
                        </ol>
                    </nav>
                    <h1 class="m-0"> {{ trans('admin.hotels') }} </h1>
                </div>
                <a href="{{ route('hotels.create') }}" class="btn btn-success ml-3">{{ trans('admin.create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {!! substr($hotel->en_description, 0, 20)  !!}
                                    </div>
                                </div>
                            </td>
                            ...
                            <td style="width:120px" class="text-center">
                                <img src="{{ $hotel->hotel_image }}" style="width: 120px; height: 50px">
                            </td>

                            <td>
                                <a href="{{ route('hotels.edit', $hotel->id) }}" class="btn btn-sm btn-link">
