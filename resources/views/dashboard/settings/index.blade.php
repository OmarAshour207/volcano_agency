                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <th style="width: 40px;" > {{ trans('home.our_services') }} </th>
                            <th style="width: 40px;" > {{ trans('home.stat') }} </th>
                            <th style="width: 40px;" > {{ trans('admin.team_members') }} </th>
                            <th style="width: 40px;" >{{ trans('admin.testimonials') }}</th>
                            <th style="width: 40px;" > {{ trans('home.latest_blog') }} </th>
                            <th style="width: 40px;" > {{ trans('home.hotel_offers') }} </th>
                            <th style="width: 40px;" > {{ trans('admin.color') }} </th>
                        ...
                        @if($websiteSettings != null)
                                <tr>
                                    ...
                                    @php
                                    $sections = ['about', 'our_projects', 'contacts','our_services', 'stat', 'team_members', 'testimonials', 'latest_blog', 'hotel_offers'];
