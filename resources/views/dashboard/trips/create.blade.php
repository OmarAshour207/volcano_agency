            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('trips.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="ar_description" name="ar_description" class="form-control ckeditor">{{ old('ar_description') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="en_description"> {{ trans('admin.trips') }} / {{ trans('admin.en_description') }}</label>
                        <textarea id="en_description" name="en_description" class="form-control ckeditor">{{ old('en_description') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="start_at" name="start_at" type="date" class="form-control" placeholder="{{ __('admin.start_at') }}" value="{{ old('start_at') }}">
                    </div>
                    <div class="form-group">
                        <label for="start_at_time"> {{ trans('admin.trips') }} / {{ trans('admin.start_at_time') }}</label>
                        <input id="start_at_time" name="start_at_time" type="time" class="form-control" placeholder="{{ __('admin.start_at_time') }}" value="{{ old('start_at_time') }}">
                    </div>

                    <div class="form-group">
                        <label for="end_at"> {{ trans('admin.trips') }} / {{ trans('admin.end_at') }}</label>
                        <input id="end_at" name="end_at" type="date" class="form-control" placeholder="{{ __('admin.end_at') }}" value="{{ old('end_at') }}">
                    </div>
                    <div class="form-group">
                        <label for="end_at_time"> {{ trans('admin.trips') }} / {{ trans('admin.end_at_time') }}</label>
                        <input id="end_at_time" name="end_at_time" type="time" class="form-control" placeholder="{{ __('admin.end_at_time') }}" value="{{ old('end_at_time') }}">
                    </div>
